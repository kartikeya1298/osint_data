...
from military_osint_terms import (
    CATEGORY_NAMES, MIL_DOMAIN_SUFFIXES, STRONG_MIL_TERMS, MIL_CONTRACTORS,
    APT_GROUPS, MIL_VENDOR_TERMS, WEAK_MIL_TERMS, NEGATIVE_TERMS,
    _DOMAIN_COUNTRY_SUFFIXES, _TECH_SIGNATURES, _HIGH_VALUE_TECH,
    _SECRET_PATTERNS, _DORK_FILE_PATTERNS, _NOISE_REPO_PATTERNS,
    _DOC_EXTS, _DOC_NAMES, _GHW_STRONG_QUERIES, _GHW_SOFT_QUERIES,
    _GHW_SKIP_EXTS, _GHW_SENSITIVE_EXTS, _GHW_NEG_FILENAME_TERMS,
    _TIER1_MIL_DOMAINS, _TIER3_GENERIC_GOV_MARKER, _TIER2_CONTRACTORS,
    _RANSOMWARE_LIVE_TARGET_COUNTRIES, _TIER1_MIL_DOMAIN_FRAGMENTS,
    _COUNTRY_TLD_HINTS, _COUNTRY_NAME_HINTS, _SHODAN_PORT_SERVICE,
    _CCTLD_SECOND_LEVEL, _COMMERCIAL_SAT_EXCLUDE, _SATCAT_OWNER_NAME,
    _MIL_MALWARE_TAGS, _ADVERSARY_TLDS, _MIL_URL_TARGETS,
    _DEEPDARKCTI_RELEVANT_TYPES, _DEEPDARKCTI_COUNTRY_KW,
)
